        ...
        <div
            ...
            {isLoading
                ...
                : (isError
                    ...
                    : videos.map(video => <div class="w-full flex flex-row gap-2 cursor-pointer hover:bg-slate-900 p-2 py-3" onClick={() => handleVideoChange(video?.id)}>
                        ...
                        <div clas="flex flex-col w-full">
                            ...
                            <div>
                                <span class="text-gray-400 text-xs mt-1">{video.duration} M</span>
