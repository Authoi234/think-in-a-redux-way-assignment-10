            ...
            <div class="mx-auto max-w-md px-5 lg:px-0 text-whtie" >
                ...
                <form class="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div class="flex items-center justify-end">
                        <div class="text-sm">
                            <a href="#" class="font-medium text-violet-600 hover:text-violet-500" onClick={() => window.confirm("You have to remember to your own. Yesterday is history, tomorrow is mistry but today is a gift, thats why it is called the present")}>
